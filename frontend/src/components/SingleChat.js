...
const SingleChat = ({ fetchAgain, setFetchAgain }) => {
  ...
  useEffect(() => {
    socket = io(ENDPOINT); //for conneting the client to backend 
    socket.emit("setup", user);//giving the user object to the setup in the server.js
  ...
  useEffect(() => {
    ...
    selectedChatCompare = selectedChat;//for making sure if new message has come or not
    // eslint-disable-next-line
  }, [selectedChat]);
